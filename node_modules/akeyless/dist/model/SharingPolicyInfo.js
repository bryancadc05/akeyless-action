 ...
 * @version 3.5.0
 */
var SharingPolicyInfo = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SharingPolicyInfo</code>.
   * @alias module:model/SharingPolicyInfo
   */
  function SharingPolicyInfo() {
    _classCallCheck(this, SharingPolicyInfo);
  ...
  _createClass(SharingPolicyInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('default_share_link_ttl')) {
          obj['default_share_link_ttl'] = _ApiClient["default"].convertToType(data['default_share_link_ttl'], 'Number');
        }
      }
...
var _default = SharingPolicyInfo;
