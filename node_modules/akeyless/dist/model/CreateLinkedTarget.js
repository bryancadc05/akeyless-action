 ...
 * @version 3.3.0
 */
var CreateLinkedTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateLinkedTarget</code>.
   * @alias module:model/CreateLinkedTarget
   * @param name {String} Target name
   */
  function CreateLinkedTarget(name) {
    _classCallCheck(this, CreateLinkedTarget);
  ...
  _createClass(CreateLinkedTarget, null, [{
    key: "initialize",
...
var _default = CreateLinkedTarget;
