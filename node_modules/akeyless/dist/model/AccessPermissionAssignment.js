 ...
 * @version 3.5.0
 */
var AccessPermissionAssignment = /*#__PURE__*/function () {
  /**
  ...
  function AccessPermissionAssignment() {
    _classCallCheck(this, AccessPermissionAssignment);
  ...
  _createClass(AccessPermissionAssignment, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('access_type')) {
          obj['access_type'] = _ApiClient["default"].convertToType(data['access_type'], 'String');
        }
