 ...
 * @version 3.3.14
 */
var CreateESMOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateESMOutput</code>.
   * @alias module:model/CreateESMOutput
   */
  function CreateESMOutput() {
    _classCallCheck(this, CreateESMOutput);
  ...
  _createClass(CreateESMOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('external_secret_manager_id')) {
          obj['external_secret_manager_id'] = _ApiClient["default"].convertToType(data['external_secret_manager_id'], 'Number');
        }

        if (data.hasOwnProperty('external_secret_manager_name')) {
          obj['external_secret_manager_name'] = _ApiClient["default"].convertToType(data['external_secret_manager_name'], 'String');
        }
      }
