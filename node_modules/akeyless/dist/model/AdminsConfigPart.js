...
var _AllowedAccessOld = _interopRequireDefault(require("./AllowedAccessOld"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('admins_migration_status')) {
          obj['admins_migration_status'] = _ApiClient["default"].convertToType(data['admins_migration_status'], 'Number');
        }

        if (data.hasOwnProperty('allowed_access')) {
          obj['allowed_access'] = _ApiClient["default"].convertToType(data['allowed_access'], {
            'String': _AllowedAccessOld["default"]
          });
        }
      }
