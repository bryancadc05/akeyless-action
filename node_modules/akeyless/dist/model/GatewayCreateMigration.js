...
var GatewayCreateMigration = /*#__PURE__*/function () {
   ...
   */
  function GatewayCreateMigration(name, siTargetName, siUsersPathTemplate, targetLocation) {
  ...
  _createClass(GatewayCreateMigration, null, [{
    key: "initialize",
    value: function initialize(obj, name, siTargetName, siUsersPathTemplate, targetLocation) {
      obj['name'] = name;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ad-ssh-port')) {
          obj['ad-ssh-port'] = _ApiClient["default"].convertToType(data['ad-ssh-port'], 'String');
        }

        if (data.hasOwnProperty('ad-targets-type')) {
          obj['ad-targets-type'] = _ApiClient["default"].convertToType(data['ad-targets-type'], 'String');
        }

        if (data.hasOwnProperty('ad-winrm-over-http')) {
          obj['ad-winrm-over-http'] = _ApiClient["default"].convertToType(data['ad-winrm-over-http'], 'String');
        }

        if (data.hasOwnProperty('ad-winrm-port')) {
          obj['ad-winrm-port'] = _ApiClient["default"].convertToType(data['ad-winrm-port'], 'String');
        }
        ...
        if (data.hasOwnProperty('si-auto-rotate')) {
          obj['si-auto-rotate'] = _ApiClient["default"].convertToType(data['si-auto-rotate'], 'String');
        }

        if (data.hasOwnProperty('si-rotation-hour')) {
          obj['si-rotation-hour'] = _ApiClient["default"].convertToType(data['si-rotation-hour'], 'Number');
        }

        if (data.hasOwnProperty('si-rotation-interval')) {
          obj['si-rotation-interval'] = _ApiClient["default"].convertToType(data['si-rotation-interval'], 'Number');
        }

        if (data.hasOwnProperty('si-sra-enable-rdp')) {
          obj['si-sra-enable-rdp'] = _ApiClient["default"].convertToType(data['si-sra-enable-rdp'], 'String');
        }

        if (data.hasOwnProperty('si-target-name')) {
          obj['si-target-name'] = _ApiClient["default"].convertToType(data['si-target-name'], 'String');
        }

        if (data.hasOwnProperty('si-users-ignore')) {
          obj['si-users-ignore'] = _ApiClient["default"].convertToType(data['si-users-ignore'], 'String');
        }

        if (data.hasOwnProperty('si-users-path-template')) {
          obj['si-users-path-template'] = _ApiClient["default"].convertToType(data['si-users-path-template'], 'String');
        }
