    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('splunk_enable_tls')) {
          obj['splunk_enable_tls'] = _ApiClient["default"].convertToType(data['splunk_enable_tls'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('splunk_tls_certificate')) {
          obj['splunk_tls_certificate'] = _ApiClient["default"].convertToType(data['splunk_tls_certificate'], 'String');
        }
