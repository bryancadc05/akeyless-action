 ...
 * @version 3.3.5
 */
var ImportPasswordsOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ImportPasswordsOutput</code>.
   * @alias module:model/ImportPasswordsOutput
   */
  function ImportPasswordsOutput() {
    _classCallCheck(this, ImportPasswordsOutput);
  ...
  _createClass(ImportPasswordsOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('imported')) {
          obj['imported'] = _ApiClient["default"].convertToType(data['imported'], 'Number');
        }

        if (data.hasOwnProperty('passwords_in_file')) {
          obj['passwords_in_file'] = _ApiClient["default"].convertToType(data['passwords_in_file'], 'Number');
        }

        if (data.hasOwnProperty('successfully_parsed')) {
          obj['successfully_parsed'] = _ApiClient["default"].convertToType(data['successfully_parsed'], 'Number');
        }
      }
...
var _default = ImportPasswordsOutput;
