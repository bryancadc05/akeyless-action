...
var _CertificateChainInfo = _interopRequireDefault(require("./CertificateChainInfo"));

var _CertificateIssueInfo = _interopRequireDefault(require("./CertificateIssueInfo"));

var _CertificateTemplateInfo = _interopRequireDefault(require("./CertificateTemplateInfo"));
...
var _ImporterInfo = _interopRequireDefault(require("./ImporterInfo"));

var _OidcClientInfo = _interopRequireDefault(require("./OidcClientInfo"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('certificate_chain_info')) {
          obj['certificate_chain_info'] = _CertificateChainInfo["default"].constructFromObject(data['certificate_chain_info']);
        }

        if (data.hasOwnProperty('certificates_template_info')) {
          obj['certificates_template_info'] = _CertificateTemplateInfo["default"].constructFromObject(data['certificates_template_info']);
        }
        ...
        if (data.hasOwnProperty('importer_info')) {
          obj['importer_info'] = _ImporterInfo["default"].constructFromObject(data['importer_info']);
        }

        if (data.hasOwnProperty('oidc_client_info')) {
          obj['oidc_client_info'] = _OidcClientInfo["default"].constructFromObject(data['oidc_client_info']);
        }
