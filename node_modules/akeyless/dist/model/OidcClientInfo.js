...
var _AccessPermissionAssignment = _interopRequireDefault(require("./AccessPermissionAssignment"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('access_permission_assignment')) {
          obj['access_permission_assignment'] = _ApiClient["default"].convertToType(data['access_permission_assignment'], [_AccessPermissionAssignment["default"]]);
        }
