 ...
 * @version 3.3.12
 */
var EsmCreateSecretOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>EsmCreateSecretOutput</code>.
   * @alias module:model/EsmCreateSecretOutput
   */
  function EsmCreateSecretOutput() {
    _classCallCheck(this, EsmCreateSecretOutput);
  ...
  _createClass(EsmCreateSecretOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('secret_id')) {
          obj['secret_id'] = _ApiClient["default"].convertToType(data['secret_id'], 'String');
        }

        if (data.hasOwnProperty('version_id')) {
          obj['version_id'] = _ApiClient["default"].convertToType(data['version_id'], 'String');
        }
      }
...
var _default = EsmCreateSecretOutput;
