    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('migration_type_name')) {
          obj['migration_type_name'] = _ApiClient["default"].convertToType(data['migration_type_name'], 'String');
        }

        if (data.hasOwnProperty('rotated_secrets')) {
          obj['rotated_secrets'] = _MigrationItems["default"].constructFromObject(data['rotated_secrets']);
        }
        ...
        if (data.hasOwnProperty('targets')) {
          obj['targets'] = _MigrationItems["default"].constructFromObject(data['targets']);
        }
      }
