    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('targets_type')) {
          obj['targets_type'] = _ApiClient["default"].convertToType(data['targets_type'], 'String');
        }
        ...
        if (data.hasOwnProperty('winrm_over_http')) {
          obj['winrm_over_http'] = _ApiClient["default"].convertToType(data['winrm_over_http'], 'Boolean');
        }

        if (data.hasOwnProperty('winrm_port')) {
          obj['winrm_port'] = _ApiClient["default"].convertToType(data['winrm_port'], 'String');
        }
      }
