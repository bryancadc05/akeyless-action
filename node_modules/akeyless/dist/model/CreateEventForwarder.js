 ...
 * @version 3.3.12
 */
var CreateEventForwarder = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateEventForwarder(eventSourceLocations, forwarderType, name, runnerType) {
    _classCallCheck(this, CreateEventForwarder);
  ...
  _createClass(CreateEventForwarder, null, [{
    key: "initialize",
    value: function initialize(obj, eventSourceLocations, forwarderType, name, runnerType) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('event-source-type')) {
          obj['event-source-type'] = _ApiClient["default"].convertToType(data['event-source-type'], 'String');
        }
        ...
        if (data.hasOwnProperty('forwarder-type')) {
          obj['forwarder-type'] = _ApiClient["default"].convertToType(data['forwarder-type'], 'String');
        }
...
var _default = CreateEventForwarder;
