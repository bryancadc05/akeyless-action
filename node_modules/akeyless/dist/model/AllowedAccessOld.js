 ...
 * @version 3.3.12
 */
var AllowedAccessOld = /*#__PURE__*/function () {
  /**
   ...
   */
  function AllowedAccessOld() {
    _classCallCheck(this, AllowedAccessOld);
  ...
  _createClass(AllowedAccessOld, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('access_permissions')) {
          obj['access_permissions'] = _ApiClient["default"].convertToType(data['access_permissions'], ['String']);
        }
