...
var GetCertificateValue = /*#__PURE__*/function () {
  ...
  _createClass(GetCertificateValue, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('certificate-file-output')) {
          obj['certificate-file-output'] = _ApiClient["default"].convertToType(data['certificate-file-output'], 'String');
        }
        ...
        if (data.hasOwnProperty('issuance-token')) {
          obj['issuance-token'] = _ApiClient["default"].convertToType(data['issuance-token'], 'String');
        }
        ...
        if (data.hasOwnProperty('private-key-file-output')) {
          obj['private-key-file-output'] = _ApiClient["default"].convertToType(data['private-key-file-output'], 'String');
        }
...
var _default = GetCertificateValue;
