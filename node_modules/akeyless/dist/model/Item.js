...
var _BastionsList = _interopRequireDefault(require("./BastionsList"));

var _CertificateIssueInfo = _interopRequireDefault(require("./CertificateIssueInfo"));

var _GatewayBasicInfo = _interopRequireDefault(require("./GatewayBasicInfo"));
...
var _LinkedDetails = _interopRequireDefault(require("./LinkedDetails"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('access_date_display')) {
          obj['access_date_display'] = _ApiClient["default"].convertToType(data['access_date_display'], 'String');
        }

        if (data.hasOwnProperty('access_request_status')) {
          obj['access_request_status'] = _ApiClient["default"].convertToType(data['access_request_status'], 'String');
        }
        ...
        if (data.hasOwnProperty('bastion_details')) {
          obj['bastion_details'] = _BastionsList["default"].constructFromObject(data['bastion_details']);
        }
        ...
        if (data.hasOwnProperty('gateway_details')) {
          obj['gateway_details'] = _ApiClient["default"].convertToType(data['gateway_details'], [_GatewayBasicInfo["default"]]);
        }

        if (data.hasOwnProperty('is_access_request_enabled')) {
          obj['is_access_request_enabled'] = _ApiClient["default"].convertToType(data['is_access_request_enabled'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('linked_details')) {
          obj['linked_details'] = _LinkedDetails["default"].constructFromObject(data['linked_details']);
        }
