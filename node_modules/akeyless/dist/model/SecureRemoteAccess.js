    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('rd_gateway_server')) {
          obj['rd_gateway_server'] = _ApiClient["default"].convertToType(data['rd_gateway_server'], 'String');
        }
        ...
        if (data.hasOwnProperty('rotate_after_disconnect')) {
          obj['rotate_after_disconnect'] = _ApiClient["default"].convertToType(data['rotate_after_disconnect'], 'Boolean');
        }
