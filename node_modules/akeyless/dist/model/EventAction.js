 ...
 * @version 3.3.16
 */
var EventAction = /*#__PURE__*/function () {
  /**
   ...
   */
  function EventAction(action, eventId) {
  ...
  _createClass(EventAction, null, [{
    key: "initialize",
    value: function initialize(obj, action, eventId) {
      obj['action'] = action;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('event-id')) {
          obj['event-id'] = _ApiClient["default"].convertToType(data['event-id'], 'Number');
        }
