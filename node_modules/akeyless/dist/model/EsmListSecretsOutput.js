...
var _SecretInfo = _interopRequireDefault(require("./SecretInfo"));
 ...
 * @version 3.3.12
 */
var EsmListSecretsOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>EsmListSecretsOutput</code>.
   * @alias module:model/EsmListSecretsOutput
   */
  function EsmListSecretsOutput() {
    _classCallCheck(this, EsmListSecretsOutput);
  ...
  _createClass(EsmListSecretsOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('secrets_list')) {
          obj['secrets_list'] = _ApiClient["default"].convertToType(data['secrets_list'], [_SecretInfo["default"]]);
        }
      }
...
var _default = EsmListSecretsOutput;
