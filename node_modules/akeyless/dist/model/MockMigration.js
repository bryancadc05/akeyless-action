...
var _MockPayload = _interopRequireDefault(require("./MockPayload"));
...
var MockMigration = /*#__PURE__*/function () {
  ...
  _createClass(MockMigration, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _MockPayload["default"].constructFromObject(data['payload']);
        }
      }
