    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('target_details')) {
          obj['target_details'] = _ApiClient["default"].convertToType(data['target_details'], 'String');
        }
        ...
        if (data.hasOwnProperty('target_sub_type')) {
          obj['target_sub_type'] = _ApiClient["default"].convertToType(data['target_sub_type'], 'String');
        }
