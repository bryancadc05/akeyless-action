 ...
 * @version 3.3.16
 */
var DeleteGatewayAllowedAccessId = /*#__PURE__*/function () {
  /**
   ...
   */
  function DeleteGatewayAllowedAccessId(accessId, clusterName) {
    _classCallCheck(this, DeleteGatewayAllowedAccessId);
  ...
  _createClass(DeleteGatewayAllowedAccessId, null, [{
    key: "initialize",
    value: function initialize(obj, accessId, clusterName) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cluster-name')) {
          obj['cluster-name'] = _ApiClient["default"].convertToType(data['cluster-name'], 'String');
        }
...
var _default = DeleteGatewayAllowedAccessId;
