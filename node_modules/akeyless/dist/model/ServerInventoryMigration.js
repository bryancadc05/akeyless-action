...
var _ServerInventoryPayload = _interopRequireDefault(require("./ServerInventoryPayload"));
 ...
 * @version 3.3.12
 */
var ServerInventoryMigration = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ServerInventoryMigration</code>.
   * @alias module:model/ServerInventoryMigration
   */
  function ServerInventoryMigration() {
    _classCallCheck(this, ServerInventoryMigration);
  ...
  _createClass(ServerInventoryMigration, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _ServerInventoryPayload["default"].constructFromObject(data['payload']);
        }
      }
...
var _default = ServerInventoryMigration;
