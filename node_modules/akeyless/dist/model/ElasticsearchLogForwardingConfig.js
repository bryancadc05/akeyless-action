    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('elasticsearch_enable_tls')) {
          obj['elasticsearch_enable_tls'] = _ApiClient["default"].convertToType(data['elasticsearch_enable_tls'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('elasticsearch_tls_certificate')) {
          obj['elasticsearch_tls_certificate'] = _ApiClient["default"].convertToType(data['elasticsearch_tls_certificate'], 'String');
        }
