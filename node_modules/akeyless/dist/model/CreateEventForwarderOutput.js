...
var CreateEventForwarderOutput = /*#__PURE__*/function () {
  ...
  _createClass(CreateEventForwarderOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('event_forwarder_id')) {
          obj['event_forwarder_id'] = _ApiClient["default"].convertToType(data['event_forwarder_id'], 'Number');
        }
      }
...
var _default = CreateEventForwarderOutput;
