 ...
 * @version 3.3.9
 */
var GatewayDeleteAllowedAccessOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GatewayDeleteAllowedAccessOutput</code>.
   * @alias module:model/GatewayDeleteAllowedAccessOutput
   */
  function GatewayDeleteAllowedAccessOutput() {
    _classCallCheck(this, GatewayDeleteAllowedAccessOutput);
  ...
  _createClass(GatewayDeleteAllowedAccessOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('allowed_access_name')) {
          obj['allowed_access_name'] = _ApiClient["default"].convertToType(data['allowed_access_name'], 'String');
        }
      }
...
var _default = GatewayDeleteAllowedAccessOutput;
