 ...
 * @version 3.3.16
 */
var GoogleChronicleForwardingConfig = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GoogleChronicleForwardingConfig</code>.
   * @alias module:model/GoogleChronicleForwardingConfig
   */
  function GoogleChronicleForwardingConfig() {
    _classCallCheck(this, GoogleChronicleForwardingConfig);
  ...
  _createClass(GoogleChronicleForwardingConfig, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('service_account_key')) {
          obj['service_account_key'] = _ApiClient["default"].convertToType(data['service_account_key'], 'String');
        }
      }
...
var _default = GoogleChronicleForwardingConfig;
