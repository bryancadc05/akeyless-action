 ...
 * @version 3.3.5
 */
var CreateWindowsTarget = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateWindowsTarget(hostname, name, password, username) {
    _classCallCheck(this, CreateWindowsTarget);
  ...
  _createClass(CreateWindowsTarget, null, [{
    key: "initialize",
    value: function initialize(obj, hostname, name, password, username) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('use-tls')) {
          obj['use-tls'] = _ApiClient["default"].convertToType(data['use-tls'], 'String');
        }
...
var _default = CreateWindowsTarget;
