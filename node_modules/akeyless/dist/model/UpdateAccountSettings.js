    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('default-key-name')) {
          obj['default-key-name'] = _ApiClient["default"].convertToType(data['default-key-name'], 'String');
        }

        if (data.hasOwnProperty('default-share-link-ttl-minutes')) {
          obj['default-share-link-ttl-minutes'] = _ApiClient["default"].convertToType(data['default-share-link-ttl-minutes'], 'String');
        }
        ...
        if (data.hasOwnProperty('invalid-characters')) {
          obj['invalid-characters'] = _ApiClient["default"].convertToType(data['invalid-characters'], 'String');
        }
        ...
        if (data.hasOwnProperty('items-deletion-protection')) {
          obj['items-deletion-protection'] = _ApiClient["default"].convertToType(data['items-deletion-protection'], 'String');
        }
        ...
        if (data.hasOwnProperty('lock-default-key')) {
          obj['lock-default-key'] = _ApiClient["default"].convertToType(data['lock-default-key'], 'String');
        }
