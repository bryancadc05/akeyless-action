    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('syslog_enable_tls')) {
          obj['syslog_enable_tls'] = _ApiClient["default"].convertToType(data['syslog_enable_tls'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('syslog_tls_certificate')) {
          obj['syslog_tls_certificate'] = _ApiClient["default"].convertToType(data['syslog_tls_certificate'], 'String');
        }
      }
