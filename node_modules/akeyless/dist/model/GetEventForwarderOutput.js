...
var _NotiForwarder = _interopRequireDefault(require("./NotiForwarder"));
 ...
 * @version 3.3.0
 */
var GetEventForwarderOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetEventForwarderOutput</code>.
   * @alias module:model/GetEventForwarderOutput
   */
  function GetEventForwarderOutput() {
    _classCallCheck(this, GetEventForwarderOutput);
  ...
  _createClass(GetEventForwarderOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('event_forwarder')) {
          obj['event_forwarder'] = _NotiForwarder["default"].constructFromObject(data['event_forwarder']);
        }
      }
...
var _default = GetEventForwarderOutput;
