 ...
 * @version 3.3.14
 */
var SumologicLogForwardingConfig = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SumologicLogForwardingConfig</code>.
   * @alias module:model/SumologicLogForwardingConfig
   */
  function SumologicLogForwardingConfig() {
    _classCallCheck(this, SumologicLogForwardingConfig);
  ...
  _createClass(SumologicLogForwardingConfig, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('sumo_logic_endpoint')) {
          obj['sumo_logic_endpoint'] = _ApiClient["default"].convertToType(data['sumo_logic_endpoint'], 'String');
        }

        if (data.hasOwnProperty('sumo_logic_host')) {
          obj['sumo_logic_host'] = _ApiClient["default"].convertToType(data['sumo_logic_host'], 'String');
        }

        if (data.hasOwnProperty('sumo_logic_tags')) {
          obj['sumo_logic_tags'] = _ApiClient["default"].convertToType(data['sumo_logic_tags'], 'String');
        }
      }
...
var _default = SumologicLogForwardingConfig;
