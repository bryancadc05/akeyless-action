 ...
 * @version 3.3.0
 */
var GatewayDownloadCustomerFragmentsOutput = /*#__PURE__*/function () {
  /**
   ...
   */
  function GatewayDownloadCustomerFragmentsOutput() {
    _classCallCheck(this, GatewayDownloadCustomerFragmentsOutput);
  ...
  _createClass(GatewayDownloadCustomerFragmentsOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cf_json')) {
          obj['cf_json'] = _ApiClient["default"].convertToType(data['cf_json'], {
            'String': Object
          });
        }
      }
...
var _default = GatewayDownloadCustomerFragmentsOutput;
