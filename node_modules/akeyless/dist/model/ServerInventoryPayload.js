 ...
 * @version 3.3.12
 */
var ServerInventoryPayload = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ServerInventoryPayload</code>.
   * @alias module:model/ServerInventoryPayload
   */
  function ServerInventoryPayload() {
    _classCallCheck(this, ServerInventoryPayload);
  ...
  _createClass(ServerInventoryPayload, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('migration_target_id')) {
          obj['migration_target_id'] = _ApiClient["default"].convertToType(data['migration_target_id'], 'Number');
        }

        if (data.hasOwnProperty('server_targets_path_template')) {
          obj['server_targets_path_template'] = _ApiClient["default"].convertToType(data['server_targets_path_template'], 'String');
        }

        if (data.hasOwnProperty('users_ignore_list')) {
          obj['users_ignore_list'] = _ApiClient["default"].convertToType(data['users_ignore_list'], {
            'String': 'Boolean'
          });
        }

        if (data.hasOwnProperty('users_rotated_secrets_path_template')) {
          obj['users_rotated_secrets_path_template'] = _ApiClient["default"].convertToType(data['users_rotated_secrets_path_template'], 'String');
        }
      }
...
var _default = ServerInventoryPayload;
