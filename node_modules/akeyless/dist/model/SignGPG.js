...
var SignGPG = /*#__PURE__*/function () {
   ...
   */
  function SignGPG(keyName, message) {
    _classCallCheck(this, SignGPG);
  ...
  _createClass(SignGPG, null, [{
    key: "initialize",
    value: function initialize(obj, keyName, message) {
