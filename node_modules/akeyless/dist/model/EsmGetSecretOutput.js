 ...
 * @version 3.3.14
 */
var EsmGetSecretOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>EsmGetSecretOutput</code>.
   * @alias module:model/EsmGetSecretOutput
   */
  function EsmGetSecretOutput() {
    _classCallCheck(this, EsmGetSecretOutput);
  ...
  _createClass(EsmGetSecretOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('binary_value')) {
          obj['binary_value'] = _ApiClient["default"].convertToType(data['binary_value'], 'Boolean');
        }
...
var _default = EsmGetSecretOutput;
