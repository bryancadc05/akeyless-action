 ...
 * @version 3.3.5
 */
var ExportClassicKey = /*#__PURE__*/function () {
  /**
   ...
   */
  function ExportClassicKey(name) {
    _classCallCheck(this, ExportClassicKey);
  ...
  _createClass(ExportClassicKey, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('export-public-key')) {
          obj['export-public-key'] = _ApiClient["default"].convertToType(data['export-public-key'], 'Boolean');
        }
